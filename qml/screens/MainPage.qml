...
Item {
    ...
    ColumnLayout {
            ...
            RowLayout {
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        Accessible.name: "taskListTabButton"

                        background: Rectangle {
                            radius: theme.cornerRadius
                            color: parent.checked ? theme.primaryColor : theme.backgroundColor
                            border.color: theme.borderColor
                            border.width: 1
                        }
                    ...
                    Button {
                        ...
                        Accessible.role: Accessible.Button
                        Accessible.name: "timetableTabButton"
        ...
        // Tab bar (hidden, just for state management)
        TabBar {
            id: tabBar
            visible: false
            currentIndex: 0

            TabButton { text: "Task List" }
            TabButton { text: "Timetable" }
        }
